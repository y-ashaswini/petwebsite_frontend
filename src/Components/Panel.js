...
export default function Panel({ showPanel, setShowPanel }) {
  ...
  return (
    <>
      <div
        className={
          "bg-blue2 border-2 z-30 border-r-4 border-b-4 rounded-md border-blue1 text-white cursor-pointer text-xs md:text-sm font-bold px-2 py-8 sticky sm:hidden text-center m-2" +
          (!u_email && " hidden")
        }
